	...
	<div class="container">
		...
		<div class="slideOptions">
			<div class="row">
				...
				<div class="col-lg-5"><input id="variable1" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="700" data-slider-step="10" data-slider-value="196" data-slider-handle="custom"/></div>
		...
		<div class="slideOptions">
			<div class="row">
				...
				<div class="col-lg-1 text-center minus"><a href="#" class="symbol"> - </a></div>
				<div class="col-lg-5"><input id="variable4" data-slider-id='ex4Slider' type="text" data-slider-min="100" data-slider-max="2000" data-slider-step="1" data-slider-value="400" data-slider-handle="custom"/></div>
				<div class="col-lg-1 text-center plus"><a href="#" class="symbol"> + </a></div>
